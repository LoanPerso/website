...
export function Process() {
  ...
  const steps = [
    { number: t("process.steps.simulate.number"), title: t("process.steps.simulate.title"), description: t("process.steps.simulate.description"), icon: icons[0] },
    { number: t("process.steps.send.number"), title: t("process.steps.send.title"), description: t("process.steps.send.description"), icon: icons[1] },
    { number: t("process.steps.response.number"), title: t("process.steps.response.title"), description: t("process.steps.response.description"), icon: icons[2] },
    { number: t("process.steps.receive.number"), title: t("process.steps.receive.title"), description: t("process.steps.receive.description"), icon: icons[3] },
  ];
    ...
    <Section theme="light" size="xl">
      <div className="text-center mb-20">
        ...
        <h2 className="font-serif text-4xl md:text-6xl">
          ...
          <br />
          <span className="text-accent">{t("process.title.line2")}</span>
        </h2>
      </div>
